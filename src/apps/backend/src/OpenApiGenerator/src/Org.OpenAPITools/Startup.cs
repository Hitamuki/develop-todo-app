            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("1.0.0", new OpenApiInfo
                    {
                        ...
                        Description = "ToDo Application API (ASP.NET Core 8.0)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.0.0/openapi.json", "ToDo Application API");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "ToDo Application API Original");
                });
            app.UseRouting();
